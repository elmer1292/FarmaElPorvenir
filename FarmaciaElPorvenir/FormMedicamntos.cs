    ...
    public partial class FormMedicamntos : Form
    {
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                ...
                string lab= gridView1.GetRowCellValue(e.RowHandle,"Id_Laboratorio.Nombre").ToString() ;
                string Cat = gridView1.GetRowCellValue(e.RowHandle, "Id_Categoria.Categorias").ToString();
